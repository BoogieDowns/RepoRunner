    ...
    switch (status) {
      ...
      case "starting":
        return (
          <span
            className={base}
            style={{ background: "rgba(255,176,0,0.10)", color: "#ffb000", border: "1px solid rgba(255,176,0,0.42)" }}
          >
      ...
      case "stopping":
        return (
          <span
            className={base}
            style={{ background: "rgba(255,176,0,0.07)", color: "#c98d00", border: "1px solid rgba(255,176,0,0.28)" }}
          >
            <Loader2 className="w-3 h-3 animate-spin flex-none" />
            Stopping
          </span>
